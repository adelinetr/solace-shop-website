    ...
    <>
      <div className="categories-section">
        ...
        <div className="categories-container">
          <CategoriesProps image={OurStory} categoryName="Our Story" />

          <CategoriesProps image={Clothes} categoryName="Explore Our Clothes" />

          <CategoriesProps image={Story} categoryName="Jewelry" />

          <CategoriesProps image={Instagram} categoryName="Our Instagram" />
        </div>
      </div>
    </>
  );
