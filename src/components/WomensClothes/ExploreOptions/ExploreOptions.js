...
export default function ExploreOptions() {
  ...
  const filteredItemsSearch = itemsData;
    ...
    <>
      <div className="explore-section">
        ...
        <ItemsProducts
          ...
          itemsData={filteredItemsSearch}
        />

        <div className="numbered-pages">
          <button
            className={`numbered-page ${activePage === 1 ? "active-page" : ""}`}
            onClick={() => handlePageChange(1)}
          >
            <a href="#">1</a>
          </button>
          <button
            className={`numbered-page ${activePage === 2 ? "active-page" : ""}`}
            onClick={() => handlePageChange(2)}
          >
            <a href="#">2</a>
          </button>
          <button
            className={`numbered-page ${activePage === 3 ? "active-page" : ""}`}
